...
def day1(data):
    ...
    os.system("cls")
    function.talk("【？？？】 停停！别打了！")
    function.talk("一个长官模样的人慌忙跑过来，关闭了保卫程序。")
    function.talk("【？？？】 （转向旁观者）我说过别动不动开警戒！你们那么慌张干嘛！")
    function.talk("【玛莉特】 （小声）我们是不是......")
    res = function.select(["走吧。","这就关了？我要打十个！"])
    if res==0:
        function.talk("你正准备离开时，那人拦住了你。")
        function.talk("【？？？】 请等一下！")
    elif res==1:
        function.talk("【？？？】 ......")
    function.talk("【？？？】 我是这个内网的长官，刚才的事......我代表整个内网向您道歉！")
    function.talk("【长官】 就当欠你个人情吧，你是第一次来这吗？")
    function.talk("【长官】 作为道歉，你们可以免费住这的旅馆，我赔个不是！")
    function.select(["没关系...","...这里是？"])
    function.talk("【长官】 这里是荒原的一个小小的局域网，大家就在这里生活。")
    function.talk("【长官】 这里的人挺好的，有什么需要，都可以提出来！")
    function.talk("【长官】 我是这的管理员，他们叫我“长官”")
